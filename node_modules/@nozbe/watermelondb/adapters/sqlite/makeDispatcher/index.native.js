...
var USE_NEW_BRIDGE_FOR_JSI_SUPPORT = true;
var SqliteNativeModulesDispatcher = /*#__PURE__*/function () {
  function SqliteNativeModulesDispatcher(tag, bridge, {
    ...
    if ('production' !== process.env.NODE_ENV) {
      (0, _common.invariant)(this._bridge, "NativeModules.(WM)DatabaseBridge is not defined! This means that you haven't properly linked WatermelonDB native module. Refer to docs for instructions about installation (and the changelog if this happened after an upgrade).");
    }
  }
...
var SqliteJsiDispatcher = /*#__PURE__*/function () {
  ...
  _proto2.call = function call(name, _args, callback) {
    ...
    if ('query' === methodName && !global.HermesInternal) {
      ...
      var _ref;
      (0, _Result.fromPromise)((_ref = USE_NEW_BRIDGE_FOR_JSI_SUPPORT ? WMDatabaseBridge : DatabaseBridge).provideSyncJson.apply(_ref, (0, _toConsumableArray2.default)(args)), callback);
      return;
    }
    try {
...
var initializeJSI = function () {
  ...
  var bridge = USE_NEW_BRIDGE_FOR_JSI_SUPPORT ? WMDatabaseBridge : DatabaseBridge;
